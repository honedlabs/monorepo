...
/**
 * @method static \Honed\Nav\Manager for(string $group, iterable $items) Configure a new navigation group
 * @method static \Honed\Nav\Manager add(string $group, iterable $items) Append navigation items to the provided group
